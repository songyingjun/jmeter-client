...
echo "=====Step1 jmeter"
cmd2="/jmeter/apache-jmeter-3.3/bin/jmeter -n -t ${ENV_JMX_FILE_NAME} -l ${ENV_JMX_FILE_NAME}_${now}.jtl -e -o ${ENV_JMX_FILE_NAME}_${now} -R${ENV_SLAVES}"
eval ${cmd2}
...
cmd5="ssh -i -o \"StrictHostKeyChecking no\" hostkey core@${ENV_PROXY_IP} \"[ -d ${treport}/ ] && echo ok || mkdir -p ${treport}/\""
eval ${cmd5}

cmd7="scp -i -o \"StrictHostKeyChecking no\" hostkey -r ${ENV_JMX_FILE_NAME}_${now} core@${ENV_PROXY_IP}:${treport}/"
eval ${cmd6}
