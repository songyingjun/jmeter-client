...
cmd5="ssh -i hostkey -o \"StrictHostKeyChecking no\" hostkey core@${ENV_PROXY_IP} \"[ -d ${treport}/ ] && echo ok || mkdir -p ${treport}/\""
eval ${cmd5}

cmd7="scp -i hostkey -o \"StrictHostKeyChecking no\" hostkey -r ${ENV_JMX_FILE_NAME}_${now} core@${ENV_PROXY_IP}:${treport}/"
eval ${cmd6}
